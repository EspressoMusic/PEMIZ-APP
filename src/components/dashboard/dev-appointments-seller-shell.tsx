...
import { DEV_APPOINTMENTS_SELLER_SHELL } from "@/lib/dev-preview-data";

export function DevAppointmentsSellerShell({ children }: { children: ReactNode }) {
  const shell = DEV_APPOINTMENTS_SELLER_SHELL;
