...
**עודכן:** יוני 2026  
**גרסה:** טיוטה 1.1 — יש לעבור על ידי עורך דין
...
- העדפות מקומיות: שפה, גודל טקסט, ערכת תצוגה (עשויות להישמר בדפדפן או באפליקציה).
- **אחסון מקומי במכשיר:** היסטוריית הזמנות, היסטוריית תורים, מבצעים שמורים, העדפות תצוגה ופרטי לקוח לשימוש חוזר — נשמרים **רק במכשיר שבו השתמשת** (דפדפן או אפליקציה), ואינם מסונכרנים לחשבונות אחרים או למכשירים אחרים.
- **חשיפה במכשיר:** המידע המקומי — כולל היסטוריית הזמנות ותורים — **גלוי ונגיש במכשיר** לכל מי שיש לו גישה פיזית או לוגית לאותו מכשיר/דפדפן. מומלץ לנעול את המכשיר ולא לשתף אותו עם אחרים אם המידע רגיש לך.
- טכני: עוגיות/אחסון מקומי לפי הצורך, לוגים.

> **הבהרה:** בעת ביצוע הזמנה חדשה, פרטי ההזמנה (שם, טלפון, פריטים) נשלחים לבעל החנות לצורך מילוי ההזמנה — זה נפרד מהיסטוריה המקומית שמוצגת לך במכשיר.
...
### אחסון מקומי אצל לקוחות קצה

- היסטוריית הזמנות, תורים והעדפות אישיות נשמרות **במכשיר בלבד** ואינן מהוות פרופיל משתמש מרכזי בשרתי Linky.
- מחיקת נתונים מקומיים: ניתן לנקות דרך הגדרות הדפדפן/האפליקציה או הסרת האפליקציה מהמכשיר.
- מידע מקומי זה **חשוף במכשיר** — כל מי שיש לו גישה למכשיר עלול לראותו.
