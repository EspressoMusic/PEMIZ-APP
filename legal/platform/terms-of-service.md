...
By accessing or using Peymiz (the **"Platform"**, **"Service"**, **"we"**, **"us"**), you agree to these Terms of Service (**"Terms"**). If you do not agree, do not use the Service.

These Terms apply to business users who register for an account and use our software. If you use the Service on behalf of a company, you represent that you have authority to bind that company.

## 2. What Peymiz Is — and Is Not

Peymiz is a **B2B software-as-a-service (SaaS) platform** for small businesses. We provide tools to manage customer orders, appointments, customer messages, and basic business operations from one dashboard.

**Peymiz is software only.** We are **not**:

- A marketplace or intermediary for sales between businesses and their customers
- A seller of physical goods or services to end customers
- A payment processor for transactions between your business and your customers
- A party to any contract, order, booking, or dispute between you and your customers

Each business using Peymiz is solely responsible for its own products, services, customers, orders, prices, delivery, refunds, taxes, and legal compliance.

## 3. SaaS Subscription Access

Access to the Platform is provided on a **subscription basis** (monthly or as otherwise offered). Your subscription grants a limited, non-exclusive, non-transferable, revocable license to use the Service for your internal business purposes during an active subscription period.

We may offer free trials or pilot access. Trial terms, duration, and conversion to paid plans will be disclosed at signup or on our pricing page.

## 4. Pilot / Beta Period

Peymiz may initially be offered as a pilot, beta, early-access, or trial version. During this period, the Platform may still be under development and may contain bugs, errors, interruptions, missing features, or changes in functionality.

By using Peymiz during a pilot or beta period, you understand and agree that:

- The Service is provided for testing, evaluation, and early business use.
- Features may be added, changed, limited, suspended, or removed at any time.
- The Platform may not be fully stable or continuously available.
- Peymiz does not guarantee that the Service will meet all business needs or produce any specific business result.
- You are responsible for reviewing your own orders, customer communications, appointments, and business data.
- You should not rely solely on Peymiz as your only recordkeeping or business-critical system during the pilot period.
- Peymiz may contact you for feedback and may use feedback to improve the Service.
- Peymiz may decide to end the pilot, move users to a paid subscription, or discontinue access with notice where practical.

To the maximum extent permitted by law, Peymiz's liability during any free pilot, beta, or early-access period is limited to USD $100 or the amount actually paid to Peymiz during the three (3) months before the event giving rise to the claim, whichever is lower.

If you do not accept the risks of using a pilot or beta service, you should not use Peymiz until the Service is commercially released.
...
- All content you upload or publish (text, images, prices, policies, FAQs, etc.)
- Products and services you offer to your customers
- Customer relationships, communications, fulfillment, and support
- Orders, appointments, cancellations, and refunds with your customers
- Compliance with applicable laws (consumer protection, privacy, tax, licensing, food safety, professional regulations, etc.)
- Obtaining all rights and permissions for content you upload
- Your own terms, privacy notices, and policies shown to your customers
...
- Sell illegal, dangerous, or prohibited products or services
- Engage in fraud, harassment, spam, or deceptive practices
- Upload malware, attempt unauthorized access, or disrupt the Platform
- Impersonate others or misrepresent your business
- Scrape, reverse engineer, or resell the Service without permission
- Use the Service in a manner that harms Peymiz, other users, or the public
...
- Breach these Terms
- Use the Service unlawfully or in a way that creates risk for Peymiz or others
- Fail to pay applicable fees
- Are required to be removed by law or court order
...
- PEYMIZ AND ITS AFFILIATES, OFFICERS, EMPLOYEES, AND SUPPLIERS WILL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR LOSS OF PROFITS, DATA, GOODWILL, OR BUSINESS OPPORTUNITIES.
- OUR TOTAL LIABILITY FOR ANY CLAIM ARISING FROM OR RELATED TO THE SERVICE SHALL NOT EXCEED THE AMOUNTS YOU PAID TO PEYMIZ IN THE **THREE (3) MONTHS** BEFORE THE EVENT GIVING RISE TO THE CLAIM (OR ONE HUNDRED US DOLLARS (USD $100) IF NO FEES WERE PAID).
